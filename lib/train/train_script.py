...
def run(settings):
    ...
    elif settings.script_name == "setrack":
        net = build_setrack(cfg)
    else:
    ...
    if settings.script_name == "ostrack" or settings.script_name == "setrack":
        # Phase 2: SETrack reuses OSTrackActor since forward interface is identical.
        # Phase 3: may switch to a dedicated SETrackActor if training differs.
